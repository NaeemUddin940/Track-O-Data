        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {brandNewData.map((item, index) => (
            <div key={index} className="group cursor-pointer">
              ...
              <button className="border border-green-500 text-green-500 px-6 py-2 rounded font-medium hover:bg-green-500 hover:text-white transition-colors uppercase text-sm">
                Shop Now
              </button>
            </div>
          ))}
